...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="contenturl" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						<input type="hidden" name="contenid" id="hidden_txt_userid" value=""/>
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            uniqueId: "contenid",                     //每一行的唯一标识，一般为主键列
	...
	function initEditUser(getSelection){
		$('#contenid').val(getSelection.contenid);
		$('#contentcatgoryid').val(getSelection.contentcatgoryid);
