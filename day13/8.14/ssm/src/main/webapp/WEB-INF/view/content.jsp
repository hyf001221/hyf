...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="contenttile" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>广告标题：</td>
								<td><input type="text" id="contenttile" name="contenttile"
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="import.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_import">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contenttile: $("#txt_search_username").val(),
	...
	function initEditUser(getSelection){
		...
		$('#contenttile').val(getSelection.contenttile);
